...
const PartnerItems = [
  ...
  { icon: PartnersIcons.InverseIcon, url: 'https://www.inverse.finance/' },
  { icon: PartnersIcons.OvernightIcon, url: 'https://overnight.fi/' },
  { icon: PartnersIcons.YFXIcon, url: 'https://yfxprotocol.xyz/' },
  { icon: PartnersIcons.ShrapIcon, url: '' },
  { icon: PartnersIcons.fBombIcon, url: '' },
  { icon: PartnersIcons.TarotIcon, url: 'https://tarot.fi/' },
  { icon: PartnersIcons.AngleIcon, url: 'https://www.angle.money/#/' },
  { icon: PartnersIcons.GMDIcon, url: 'https://gmdprotocol.com/' },
];
